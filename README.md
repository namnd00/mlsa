...
<br>
&emsp; &emsp; &emsp; 
➙ `5.1 Register Model`<br>
&emsp; &emsp; &emsp; 
➙ `5.2 Update Registered Model`<br>
...
<a href="https://dvc.org/" target="_blank"><img alt="DVC" src="https://img.shields.io/badge/DVC-945DD6?style=for-the-badge&logo=dataversioncontrol&logoColor=white" height="20"/></a>: Data Version Control<br>
...
4. Run the development enviroment

```commandline
make env_up
```

5. Restart the development enviroment
```commandline
make env_down
```
...
## How to access to DVC studio

- Access to DVC Studio following the link below: https://studio.iterative.ai/
- Sign in to DVC Studio by using the github account
- Add the project to the DVC Project
